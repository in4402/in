...
<body>	
	...
	<div id="wrap">
		<!-- header -->				
		<header id="header">
			<h1><a href="<c:url value='/index.do'/>"><img alt="로고 이미지" src="${pageContext.request.contextPath}/images/herbLogo7.jpg" height="95px" /></a></h1>
			<nav id="headerRight">
				<ul class="views">
					<c:if test="${!empty sessionScope.userid }">			
						<li><a href="<c:url value='/login/logout.do'/>">로그아웃</a></li>
						<li><a href="<c:url value='/member/memberEdit.do'/>">회원정보수정</a></li>	 
						<li><a href="<c:url value='/member/memberOut.do'/>">회원 탈퇴</a></li>
					</c:if>
					<c:if test="${empty sessionScope.userid }">	
